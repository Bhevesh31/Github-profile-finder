  ...
  return (
    <div className='h-[25%] sm:h-[25%] flex items-center justify-center sm:justify-between pt-10 sm:pt-5 gap-4 flex-col  '>
        ...
        <form onSubmit={(e)=>
            ...
            }} className='border text-slate-100 bg-[#115E59] sm:w-120 border-[#0F766E]  px-2 py-1 sm:px-2.5 rounded-xl sm:py-2.5 focus:outline-none focus:border-[#5EEAD4] placeholder-slate-300 ' type="text" placeholder=' Search username' />
